...
```
```{r}
dt %>% case_when(offensetime_discrete == night ~ '>= 10.00pm but <= 5.00 am', offensetime_discrete == morning ~ '>5.00am but <= 10.30am', offensetime_discrete == day ~ '>10.30am but < 2.00pm', offensetime_discrete == afternoon ~ '>=2.00pm but < 5.30 pm', offensetime_discrete == evening ~ 'anything else')
```
