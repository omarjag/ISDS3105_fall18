...
ggplot() +
  geom_line(data =  twitter_users, aes(x = Year, y = millions, color = 'green')) + geom_point(data =  twitter_users, aes(x = Year, y = millions, color = 'blue'))
```
...
ggplot() +
  geom_line(data =  twitter_users, aes(x = Year, y = millions, color = 'green')) + geom_line(data =  sn_users, aes(x = year, y = facebook, color = 'blue'))
```
